...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<prettier_print>.freeze, [">= 1.2.1"])
    s.add_runtime_dependency(%q<syntax_tree>.freeze, [">= 6.0.0"])
    ...
    s.add_dependency(%q<prettier_print>.freeze, [">= 1.2.1"])
    s.add_dependency(%q<syntax_tree>.freeze, [">= 6.0.0"])
