      ...
      e
        ? (!(function (e, s) {
            e instanceof HTMLElement || t(TypeError, "parameter 1 is not of type 'HTMLElement'"),
              ...
              e.form == s ||
                t(DOMException, 'The specified element is not owned by this form element', 'NotFoundError');
          })(e, this),
          e.click())
...
function $(e, t = {}) {
  const s = new Headers(t.headers || {}),
    r = m();
  return U.add(r), s.append('X-Turbo-Request-Id', r), _(e, { ...t, headers: s });
}
function j(e) {
...
function ve(e, t, { callbacks: s, ...r } = {}) {
  be.morph(e, t, { ...r, callbacks: new we(s) });
}
function Se(e, t) {
  ve(e, t.childNodes, { morphStyle: 'innerHTML' });
}
class we {
  #l;
...
class ye extends ge {
  static renderElement(e, t) {
    o('turbo:before-frame-morph', { target: e, detail: { currentElement: e, newElement: t } }), Se(e, t);
  }
  async preservingPermanentElements(e) {
    return await e();
  }
...
class Ae extends ne {
  detailsByOuterHTML = this.children
    ...
    .reduce((e, t) => {
      const { outerHTML: s } = t,
        r = s in e ? e[s] : { type: Re(t), tracked: Le(t), elements: [] };
...
const Pe = {
  ...
  xe = -1,
  Ve = -2,
  We = { advance: 'forward', restore: 'back', replace: 'none' };
class Ue {
  identifier = m();
  timingMetrics = {};
  followedRedirect = !1;
  ...
  async requestSucceededWithResponse(e, t) {
    ...
    null == s
      ? this.recordResponse({ statusCode: Ve, redirected: r })
  ...
  requestErrored(e, t) {
    this.recordResponse({ statusCode: De, redirected: !1 });
  }
  requestFinished() {
    this.finishRequest();
  }
  ...
  async render(e) {
    this.cancelRender(),
      await new Promise((e) => {
        this.frame =
          'hidden' === document.visibilityState ? setTimeout(() => e(), 0) : requestAnimationFrame(() => e());
      }),
      await e(),
      delete this.frame;
  }
...
class $e {
  ...
  visitProposedToLocation(e, t) {
    N(e, this.navigator.rootLocation)
  ...
  reload(e) {
    o('turbo:reload', { detail: e }), (window.location.href = this.location?.toString() || window.location.href);
  }
  get navigator() {
...
const Xe = (e) =>
  ...
  et = (e) => o('turbo:before-prefetch', { target: e, cancelable: !0 }).defaultPrevented;
class tt {
  constructor(e) {
    this.delegate = e;
  }
  ...
  startVisit(e, t, s = {}) {
    this.stop(),
      (this.currentVisit = new Ue(this, I(e), t, { referrer: this.location, ...s })),
...
class ut extends dt {
  static renderElement(e, t) {
    ve(e, t, { callbacks: { beforeNodeMorphed: (e) => !mt(e) } });
  ...
  wt = new (class {
    ...
    constructor(e) {
      (this.recentRequests = e),
        (this.preloader = new gt(this, this.view.snapshotCache)),
    ...
    canPrefetchRequestToLocation(e, t) {
      return (
        ...
        N(t, this.snapshot.rootLocation) &&
...
function Ot(e, t) {
  if (e) {
    ...
    if (null != i && null != t && ((s = t), I(i).href == I(s).href))
...
class Dt extends HTMLElement {
  ...
  get beforeRenderEvent() {
    return new CustomEvent('turbo:before-stream-render', {
      bubbles: !0,
      cancelable: !0,
      detail: { newStream: this, render: Dt.renderElement },
    });
  }
...
(r.delegateConstructor = class {
  ...
  async #V(e, t) {
    ...
    if (s) {
      ...
      this.view.renderPromise && (await this.view.renderPromise),
        ...
        (this.complete = !0),
        wt.frameRendered(e, this.element),
        wt.frameLoaded(this.element),
  ...
  async #G(e) {
    ...
    return wt.visit(r, { response: { redirected: i, statusCode: n, responseHTML: s } });
  }
  #m(e, t) {
  ...
  async extractForeignFrameElement(e) {
    ...
    try {
      ...
      if (((t = Ot(e.querySelector(`turbo-frame[src][recurse~=${s}]`), this.sourceURL)), t))
  ...
  void 0 === customElements.get('turbo-stream') && customElements.define('turbo-stream', Dt),
  void 0 === customElements.get('turbo-stream-source') && customElements.define('turbo-stream-source', xt),
  (() => {
  ...
  (window.Turbo = { ...qt, StreamActions: Nt }),
  At();
...
async function jt(e, t) {
  const { subscriptions: s } = await Ut();
  return s.create(e, t);
}
var zt = Object.freeze({ __proto__: null, getConsumer: Ut, setConsumer: _t, createConsumer: $t, subscribeTo: jt });
function Gt(e) {
...
void 0 === customElements.get('turbo-cable-stream-source') && customElements.define('turbo-cable-stream-source', Jt),
  (window.Turbo = Vt),
...
var Xt = { logger: self.console, WebSocket: self.WebSocket },
  Kt = {
    log(...e) {
...
class Zt {
  ...
  start() {
    this.isRunning() ||
      ...
      Kt.log(`ConnectionMonitor started. stale threshold = ${this.constructor.staleThreshold} s`));
  }
  stop() {
    this.isRunning() &&
      ((this.stoppedAt = Qt()),
      ...
      Kt.log('ConnectionMonitor stopped'));
  }
  isRunning() {
  ...
  recordConnect() {
    (this.reconnectAttempts = 0),
      ...
      Kt.log('ConnectionMonitor recorded connect');
  }
  recordDisconnect() {
  ...
  reconnectIfStale() {
    this.connectionIsStale() &&
      (Kt.log(
        `ConnectionMonitor detected stale connection. reconnectAttempts = ${this.reconnectAttempts}, time stale = ${Yt(this.refreshedAt)} s, stale threshold = ${this.constructor.staleThreshold} s`,
      ),
      this.reconnectAttempts++,
      this.disconnectedRecently()
        ? Kt.log(
            `ConnectionMonitor skipping reopening recent disconnect. time disconnected = ${Yt(this.disconnectedAt)} s`,
          )
        : (Kt.log('ConnectionMonitor reopening'), this.connection.reopen()));
  }
  get refreshedAt() {
...
(Zt.staleThreshold = 6), (Zt.reconnectionBackoffRate = 0.15);
var es = Zt,
  ts = {
    message_types: {
      welcome: 'welcome',
...
const { message_types: ss, protocols: rs } = ts,
  is = rs.slice(0, rs.length - 1),
  ns = [].indexOf;
class os {
  constructor(e) {
  ...
  open() {
    if (this.isActive()) return Kt.log(`Attempted to open WebSocket, but existing socket is ${this.getState()}`), !1;
    {
      ...
      return (
        Kt.log(`Opening WebSocket, current state is ${this.getState()}, subprotocols: ${e}`),
        this.webSocket && this.uninstallEventHandlers(),
        (this.webSocket = new Xt.WebSocket(this.consumer.url, e)),
  ...
  reopen() {
    ...
    try {
      ...
      Kt.log(`Reopening WebSocket in ${this.constructor.reopenDelay}ms`),
  ...
  getState() {
    if (this.webSocket)
      for (let e in Xt.WebSocket) if (Xt.WebSocket[e] === this.webSocket.readyState) return e.toLowerCase();
    return null;
  }
  ...
  (os.prototype.events = {
    message(e) {
      ...
      switch (n) {
        ...
        case ss.disconnect:
          return Kt.log(`Disconnecting. Reason: ${r}`), this.close({ allowReconnect: i });
        case ss.ping:
    ...
    open() {
      if (
        (Kt.log(`WebSocket onopen event, using '${this.getProtocol()}' subprotocol`),
        (this.disconnected = !1),
        !this.isProtocolSupported())
      )
        return (
          Kt.log('Protocol is unsupported. Stopping monitor and disconnecting.'), this.close({ allowReconnect: !1 })
        );
    },
    close(e) {
      if ((Kt.log('WebSocket onclose event'), !this.disconnected))
        return (
          (this.disconnected = !0),
...
var ls = class {
  ...
  guarantee(e) {
    -1 == this.pendingSubscriptions.indexOf(e)
      ? (Kt.log(`SubscriptionGuarantor guaranteeing ${e.identifier}`), this.pendingSubscriptions.push(e))
      : Kt.log(`SubscriptionGuarantor already guaranteeing ${e.identifier}`),
      this.startGuaranteeing();
  }
  forget(e) {
    Kt.log(`SubscriptionGuarantor forgetting ${e.identifier}`),
...
export { Vt as Turbo, zt as cable };
