...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(factory)
      : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self), (global.Rails = factory()));
})(this, function () {
  'use strict';
  ...
  const handleConfirmWithRails = (rails) =>
    function (e) {
  ...
  const handleMethodWithRails = (rails) =>
    function (e) {
      const link = this;
  ...
  const handleRemoteWithRails = (rails) =>
    function (e) {
      let data, method, url;
      const element = this;
      if (!isRemote(element)) {
